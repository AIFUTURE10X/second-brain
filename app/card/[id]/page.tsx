...
export default function CardPopoutPage() {
  ...
  const isVideoCard = isVideoUrl(form.url);
  ...
  return (
    <div className="min-h-screen bg-brand-dark text-gray-200 p-5 max-w-2xl mx-auto">
      ...
      {/* Transcript — video cards only, collapsed by default. Shares one
          implementation with the expanded grid card. */}
      {isVideoCard && <TranscriptSection itemId={id} />}
